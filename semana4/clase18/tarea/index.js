...
function getselector() {
  ...
  if (selector === "cancion1") {
    ...
    letraCancion.textContent = `Decir adiós
    Fue difícil para mi
    Porque te quise
    Desde que te conoci
    Estoy aqui
    ...
    letraCancion.textContent = `All that you touch
    ...
    letraCancion.textContent = `Fin
    Del tiempo para el que no ve
    Para el que duda y miente
    Y cree que se salvara
    
    Fe
    No se encuentra en lo material
    Es una escala espiritual
    Que aún nos falta conocer
    
    Libre
    Sólo serás con verdad
    Perdona y aprende a pedir perdón
    Eso es libertad
    
    No mires más
    Lo que te daña
    Porque no es una aventura
    Es tu vida real
    ...
    letraCancion.textContent = `It was nine twenty-nine
    ...
    return "Este selector es muy agradable";
  } else if (selector === "cancion5") {
    title.textContent = "Sed";
    letraCancion.textContent = `Tengo sed
    te nesecito
